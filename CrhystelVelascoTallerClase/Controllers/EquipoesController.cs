...
namespace CrhystelVelascoTallerClase.Controllers
{
    public class EquipoesController : Controller
    {
        ...
        public EquipoesController(CrhystelVelascoTallerClaseContext context)
        {
            _context = context;
        }
        ...
        {
            var crhystelVelascoTallerClaseContext = _context.Equipo.Include(e => e.Estadio);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Ciudad,Titulo,AceptaExtranjeros,IdEstadio")] Equipo equipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Ciudad,Titulo,AceptaExtranjeros,IdEstadio")] Equipo equipo)
        {
            if (id != equipo.Id)
            {
                return NotFound();
